...
<div class="folders-modal">
    <div class="folders-dialog">
        <div class="folders-header">
            <div class="folders-title"><?php esc_html_e("Select Role", 'folders'); ?></div>
        ...
        <div class="folders-data">
            ...
            <p><?php esc_html_e("To create a new profile entry, select a registered WordPress role from the list below.", 'folders'); ?></p>
